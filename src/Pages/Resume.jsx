...
//             <p className="mb-4 dark:text-blue-500 text-blue-500">Click the button below to view or download my resume.</p>
//             <a
//                 href={resumePDF} 
//                 target="_blank"
//                 rel="noopener noreferrer"
//                 className="inline-block bg-blue-500 hover:bg-blue-700 hover:text-white text-white font-bold py-2 px-4 rounded"
//             >
//                 View My Resume
//             </a>
//         </section>
